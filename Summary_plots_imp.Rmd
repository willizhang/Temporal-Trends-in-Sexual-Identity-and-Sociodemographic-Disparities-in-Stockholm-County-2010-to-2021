...
prop_imp_summary_2010 <- read_excel(here("prop_imp_summary_2010.xlsx"))
prop_imp_summary_2014 <- read_excel(here("prop_imp_summary_2014.xlsx"))
prop_imp_summary_2021 <- read_excel(here("prop_imp_summary_2021.xlsx"))
...
ggsave( "Final_plots/p_imp_homosexual.svg", plot = p_imp_homosexual, width = 12.3, height = 8 )
```
...
plot( p_imp_bisexual )
ggsave( "Final_plots/p_imp_bisexual.svg", plot = p_imp_bisexual, width = 12.3, height = 8 )
```
...
```{r}
# datasets for proportion of sexual identity
prop_imp_summary_2010_generation <- read_excel(here("prop_imp_summary_2010.xlsx"))
prop_imp_summary_2014_generation <- read_excel(here("prop_imp_summary_2014.xlsx"))
prop_imp_summary_2021_generation <- read_excel(here("prop_imp_summary_2021.xlsx"))
...
p_generation_sex
ggsave( "Final_plots/p_imp_generation_sex.svg", plot = p_generation_sex, width = 7, height = 6 )
...
```{r}
prop_imp_age_iteration_2010 <- read_excel(here("prop_imp_age_iteration_2010.xlsx")) %>%
  filter( subgroup == 'young' ) %>%
  select( -subgroup )

prop_imp_age_iteration_2014 <- read_excel(here("prop_imp_age_iteration_2014.xlsx")) %>%
  filter( subgroup == 'young' ) %>%
  select( -subgroup )

prop_imp_age_iteration_2021 <- read_excel(here("prop_imp_age_iteration_2021.xlsx")) %>%
  filter( subgroup == 'young' ) %>%
  select( -subgroup )
...
```{r}
prop_imp_age_group_2010 <- read_excel(here("prop_imp_age_group_sex_2010.xlsx")) %>%
...
prop_imp_age_group_2014 <- read_excel(here("prop_imp_age_group_sex_2014.xlsx")) %>%
...
prop_imp_age_group_2021 <- read_excel(here("prop_imp_age_group_sex_2021.xlsx")) %>%
...
ggsave( "Final_plots/p_imp_bisexual_age.svg", plot = p_bisexual_age, width = 9, height = 5.5 )
...
prop_imp_lgb_2010 <- read_excel(here("prop_imp_lgb_2010.xlsx"))
...
prop_imp_lgb_2014 <- read_excel(here("prop_imp_lgb_2014.xlsx"))

prop_imp_lgb_2021 <- read_excel(here("prop_imp_lgb_2021.xlsx"))
...
prop_imp_lgb_summary_long$sexual_identity[ prop_imp_lgb_summary_long$sexual_identity == "LGB" ] <- "Bisexual or homosexual"
```
...
ggplot( prop_imp_lgb_summary_long %>% 
  ...
  scale_color_manual( values = c( "#C77CFF", "#00BFC4", "#F8766D"  ),
                      breaks = c( "Bisexual", "Homosexual", "Bisexual or homosexual" ),
                      guide = guide_legend( nrow = 1 ) ) +
...
p_lgb_trends_by_sex
ggsave( "Final_plots/p_imp_lgb_sex.svg", plot = p_lgb_trends_by_sex, width = 6, height = 5/0.9 )
```
...
p_lgb_trends_by_age
ggsave( "Final_plots/p_imp_lgb_age.svg", plot = p_lgb_trends_by_age, width = 10, height = 5 )
```
...
p_lgb_trends_by_age_sex
ggsave( "Final_plots/p_imp_lgb_age_sex.svg", plot = p_lgb_trends_by_age_sex, width = 10, height = 6 )
```

### 3. Plots for Relation between Sexual Identity and Demographic Factors
#### 3.1. Prepare dataset for plotting
```{r}
results_imp_pr_poisson_2010 <- read_excel(here("results_imp_pr_poisson_2010.xlsx"))

results_imp_pr_poisson_2014 <- read_excel(here("results_imp_pr_poisson_2014.xlsx"))

results_imp_pr_poisson_2021 <- read_excel(here("results_imp_pr_poisson_2021.xlsx"))
...
results_imp_pr_poisson_homosexual <- results_imp_pr_poisson[ -c( 9:14, 23:37 ), selected_cols ]
...
ggsave( "Final_plots/p_imp_pr_homosexual_part_1.svg", plot = p_imp_pr_poisson_homosexual, width = 10.8, height = 8 )
```

##### 3.3.2. Part 2
```{r}
results_imp_pr_poisson_homosexual <- results_imp_pr_poisson[ -c( 1:22 ), selected_cols ]
...
plot( p_imp_pr_poisson_homosexual )
ggsave( "Final_plots/p_imp_pr_homosexual_part_2.svg", plot = p_imp_pr_poisson_homosexual, width = 10.8, height = 7.4 )
```
...
ggsave( "Final_plots/p_imp_pr_bisexual_part_1.svg", plot = p_imp_pr_poisson_bisexual, width = 10.8, height = 8.5 )
```
...
plot( p_imp_pr_poisson_bisexual )
ggsave( "Final_plots/p_imp_pr_bisexual_part_2.svg", plot = p_imp_pr_poisson_bisexual, width = 10.8, height = 6.8 )
```
...
plot( p_imp_pr_poisson_bisexual )
ggsave( "Final_plots/p_imp_pr_bisexual_age_sex.svg", plot = p_imp_pr_poisson_bisexual, width = 10.4, height = 5.8 )
```
