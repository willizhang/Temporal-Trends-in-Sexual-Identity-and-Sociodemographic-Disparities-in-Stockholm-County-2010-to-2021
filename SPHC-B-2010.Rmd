...
d_2010$generation_sex <- interaction( d_2010$generation, d_2010$sex )
...
d_2010 <- d_2010 %>%
  mutate( sexual_identity_reported = ifelse( is.na( sexual_identity_2010 ), "missing", "reported" ) ) %>%
...
for ( cat in categories ) {
  prop_cc_generation_sex <- svyby( formula = as.formula( paste0( "~ I( sexual_identity_2010 == '", cat, "' )" ) ),
                                   by = ~ generation_sex,
                                   design = subset( survey_design_cc, !is.na( sexual_identity_2010 ) & !is.na( generation_sex ) ),
                                   FUN = svyciprop,
                                   vartype = "ci",
                                   method = "beta" )
  
  colnames( prop_cc_generation_sex ) <- c( "subgroup", paste0( cat, "_point_estimate_2010" ), paste0( cat, "_lower_ci_2010" ), paste0( cat, "_upper_ci_2010" ) )
...
prop_cc_generation_sex <- left_join( prop_cc_generation_sex,
                          d_2010_complete_cc[ !is.na( d_2010_complete_cc$sexual_identity_2010 ) & 
                                                !is.na( d_2010_complete_cc$generation_sex ), ] %>% 
...
d_2010_iteration_age_group$age_group_sex <- interaction( d_2010_iteration_age_group$age_group, d_2010_iteration_age_group$sex )
table( d_2010_iteration_age_group$age_group_sex, useNA = "always" )
...
for ( cat in categories ) {
  prop_cc_age_group_sex <- svyby( formula = as.formula( paste0( "~ I( sexual_identity_2010 == '", cat, "' )" ) ),
                                  by = ~ age_group_sex,
                                  design = subset( survey_design_iteration_age_group,
                                                   !is.na( sexual_identity_2010 ) & !is.na( age_group_sex ) ),
                                  FUN = svyciprop,
                                  vartype = "ci",
                                  method = "beta" )
  
  colnames( prop_cc_age_group_sex ) <- c( "subgroup", paste0( cat, "_point_estimate_2010" ), paste0( cat, "_lower_ci_2010" ), paste0( cat, "_upper_ci_2010" ) )
...
writexl::write_xlsx( prop_cc_age_group_sex, "prop_cc_age_group_sex_2010.xlsx" )
```
...
# among age group
prop_imp_age_group_sex <- calc_prop_imp_subgroup( implist = implist_2010_transformed,
                                                  design = survey_design_imp,
                                                  sexual_identities = sexual_identities,
                                                  demog_var = "age_group_sex",
                                                  year = 2010 )
writexl::write_xlsx( prop_imp_age_group_sex, "prop_imp_age_group_sex_2010.xlsx" )
...
colnames( prop_lgb ) <- c( "subgroup", "LGB_point_estimate_2010", "LGB_lower_ci_2010", "LGB_upper_ci_2010" )
...
colnames( prop_lgb_sex ) <- c( "subgroup", "LGB_point_estimate_2010", "LGB_lower_ci_2010", "LGB_upper_ci_2010" )
...
colnames( prop_lgb_age ) <- c( "subgroup", "LGB_point_estimate_2010", "LGB_lower_ci_2010", "LGB_upper_ci_2010" )
...
colnames( prop_lgb_age_sex ) <- c( "subgroup", "LGB_point_estimate_2010", "LGB_lower_ci_2010", "LGB_upper_ci_2010" )

prop_lgb_summary <- rbind( prop_lgb, prop_lgb_sex, prop_lgb_age, prop_lgb_age_sex  )
writexl::write_xlsx( prop_lgb_summary, "prop_imp_lgb_2010.xlsx" )
```
...
d_2010_cc_model <- d_2010_complete
summary( d_2010_cc_model )
...
d_2010_cc_model$age_exp <- relevel( d_2010_cc_model$age_cat, ref = "45-59" )

d_2010_cc_model$sex_exp <- relevel( d_2010_cc_model$sex, ref = "Male" )

d_2010_cc_model$country_of_birth <- factor( 
  ifelse( d_2010_cc_model$country_of_birth == "Sweden", "Sweden",
          ifelse( d_2010_cc_model$country_of_birth == "Europe", "Europe", "Outside Europe" ) ),
  levels = c( "Sweden", "Europe", "Outside Europe" )
  )
d_2010_cc_model$country_of_birth_exp <- d_2010_cc_model$country_of_birth

d_2010_cc_model$education_exp <- relevel( d_2010_cc_model$education, ref = ">=13 years" )

d_2010_cc_model$income_exp <- relevel( d_2010_cc_model$income, ref = ">4,500" )

d_2010_cc_model$marital_status_exp <- relevel( d_2010_cc_model$marital_status, ref = "Currently married" )

d_2010_cc_model$living_status_exp <- relevel( d_2010_cc_model$living_alone, ref = "no" )

d_2010_cc_model$personal_support_exp <- relevel( d_2010_cc_model$personal_support, ref = "yes" )


# outcomes of interest, including sexual minority, homosexual, bisexual, and other
d_2010_cc_model$sexual_minority <- ifelse( d_2010_cc_model$sexual_identity_2010 == "Heterosexual", 0, 1 )

d_2010_cc_model$homosexual <- ifelse( d_2010_cc_model$sexual_identity_2010 == "Homosexual", 1, 0 )

d_2010_cc_model$bisexual <- ifelse( d_2010_cc_model$sexual_identity_2010 == "Bisexual", 1, 0 )

d_2010_cc_model$other <- ifelse( d_2010_cc_model$sexual_identity_2010 == "Uncertain", 1, 0 )


# confounding variables, including age, sex, country of birth, education, income, and marital status
d_2010_cc_model$age_conf <- d_2010_cc_model$age # age

d_2010_cc_model$sex_conf <- d_2010_cc_model$sex # sex

d_2010_cc_model$country_of_birth_conf <- d_2010_cc_model$country_of_birth # country of birth

d_2010_cc_model$education_conf <- d_2010_cc_model$education # education

d_2010_cc_model$income_conf <- d_2010_cc_model$dispink2010 # disposable income

d_2010_cc_model$marital_status_conf <- d_2010_cc_model$marital_status # marital status
...
d_2010_cc_model$sex_exp <- relevel( d_2010_cc_model$sex, ref = "Female" )
...
exposures_age <- c( "age_exp18-29", "age_exp30-44", "age_exp>=60"  )
...
exposures_age_male <- c( "age_exp18-29", "age_exp30-44", "age_exp>=60", "age_exp18-29:sex_expFemale", "age_exp30-44:sex_expFemale", "age_exp>=60:sex_expFemale" )
exposures_age_female <- c( "age_exp18-29", "age_exp30-44", "age_exp>=60", "age_exp18-29:sex_expMale", "age_exp30-44:sex_expMale", "age_exp>=60:sex_expMale" )
...
writexl::write_xlsx( merge( results_cc_pr_crude, results_cc_pr_poisson, by = "Exposure" ),
                     "results_cc_pr_poisson_2010.xlsx" )
...
results_cc_pr_all_models_2010 <- results_cc_pr_poisson %>%
  full_join( results_cc_pr_log_binomial, by = "Exposure" ) %>%
  full_join( results_cc_pr_logistic, by = "Exposure" )

writexl::write_xlsx( results_cc_pr_all_models_2010, "results_cc_pr_all_models_2010.xlsx" )
```
...
implist_2010_transformed_refit <- lapply( implist_2010_transformed, function( df ) {
  within( df, {
...
survey_design_imp_refit <- svydesign( ids = ~ 1,
                                      ...
                                      weights = ~ calibrated_weight,
                                      fpc = ~ no.of.population,
                                      data = imputationList( implist_2010_transformed_refit )
                                      ) # without pre-calibration
...
# export results
results_imp_pr_poisson_2010 <- merge( results_crude_model_summary,
                                      merge( results_adjusted_model_1_summary, 
                                             results_adjusted_model_2_summary, 
                                             by = "subgroup" ), 
                                      by = "subgroup" )

writexl::write_xlsx( results_imp_pr_poisson_2010, "results_imp_pr_poisson_2010.xlsx" )
```
