...
d_2021$dispink2021 <- d_2021$dispink2021*( 343.19/335.92 ) # Consumer Price Index (CPI)-adjusted income using the year 2021 as the reference (https://www.statistikdatabasen.scb.se/pxweb/en/ssd/START__PR__PR0101__PR0101L/KPIFastAmed/table/tableViewLayout1/)
...
d_2021 <- d_2021 %>%
  mutate( sexual_identity_reported = ifelse( is.na( sexual_identity_2021 ), "missing", "reported" ) ) %>%
