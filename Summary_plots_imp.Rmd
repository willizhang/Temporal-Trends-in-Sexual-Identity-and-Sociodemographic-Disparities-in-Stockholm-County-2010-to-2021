...
prop_imp_summary_2010 <- prop_imp_summary_2010 %>% slice( -c( 5:14 ) )
prop_imp_summary_2014 <- prop_imp_summary_2014 %>% slice( -c( 5:16 ) )
prop_imp_summary_2021 <- prop_imp_summary_2021 %>% slice( -c( 5:16 ) )
...
prop_imp_summary_2010_generation <- prop_imp_summary_2010_generation %>% slice( 5:14 )
prop_imp_summary_2014_generation <- prop_imp_summary_2014_generation %>% slice( 5:16 )
prop_imp_summary_2021_generation <- prop_imp_summary_2021_generation %>% slice( 5:16 )
...
summary( long_data_generation )

# plotting for homosexual and bisexual identities
ggplot( drop_na( long_data_generation %>% 
                   filter( identity %in% c( "Bisexual", "Homosexual" ) ) ),
        aes( x = year, y = proportion, color = generation, group = generation ) ) +
  
  geom_line( linewidth = 0.5 ) + 
  geom_point( size = 2 ) +
  
  scale_x_discrete( expand = c( 0.075, 0 ), position = "bottom" ) +
  ...
  facet_grid( identity ~ sex,
              switch = "y",
              scales = "free_y" ) + 
  
  ggh4x::facetted_pos_scales( y = list(
    identity == "Bisexual" ~ scale_y_continuous( labels = scales::percent, limits = c( 0, 0.152 ), breaks = c( 0, 0.05, 0.1, 0.15 ) ),
    identity == "Homosexual" ~ scale_y_continuous( labels = scales::percent, limits = c( 0, 0.04 ), breaks = c( 0, 0.01, 0.02, 0.03, 0.04 ) )
  ) )


# plotting for heterosexual and other identities
ggplot( drop_na( long_data_generation %>% 
  ...
  scale_x_discrete( expand = c( 0.05, 0 ), position = "bottom" ) +
  
  scale_color_manual( values = c( "#C77CFF", "#00BFC4", "#7CAE00", "#F8766D", "orange", "brown" ),
                      breaks = c( "Generation Z (1997–2012)", "Generation X (1965–1980)", "Silent Generation (1928–1945)", "Millennials (1981–1996)", "Baby Boomers (1946–1964)", "Greatest Generation (1901–1927)" ),
                      labels = c( "Generation Z (1997–2012)ᵇ    ", "Generation X (1965–1980)    ", "Silent Generation (1928–1945)   ", "Millennials (1981–1996)", "Baby Boomers (1946–1964)", "Greatest Generation (1901–1927)" ),
                      guide = guide_legend( nrow = 3 ) ) +
  ...
  facet_grid( identity ~ sex,
              switch = "y",
              scales = "free_y",
              labeller = labeller( identity = c( "Heterosexual" = "Heterosexual",
                                                 "Other" = "Otherᵃ" ) ) ) + 
  
  ggh4x::facetted_pos_scales( y = list(
    identity == "Heterosexual" ~ scale_y_continuous( labels = scales::percent, limits = c( 0.6, 1 ), breaks = c( 0.6, 0.7, 0.8, 0.9, 1 ) ),
    identity == "Other" ~ scale_y_continuous( labels = scales::percent, limits = c( 0, 0.4 ), breaks = c( 0, 0.1, 0.2, 0.3, 0.4 ) )
  ) )
```

#### 2.8. Proportion by varing age cut-offs
```{r}
prop_imp_age_iteration_2010 <- read_excel("/Users/guoqiang.zhang/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Karolinska Institutet/Research Projects/Population Trends and Individual Fluidity of Sexual Identity in Stockholm County/Original Research/Temporal-Trends-in-Sexual-Identity-and-Sociodemographic-Disparities-in-Stockholm-County-2010-to-2021/prop_imp_age_iteration_2010.xlsx") %>%
  filter( subgroup == 'young' ) %>%
  select( -subgroup )

prop_imp_age_iteration_2014 <- read_excel("/Users/guoqiang.zhang/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Karolinska Institutet/Research Projects/Population Trends and Individual Fluidity of Sexual Identity in Stockholm County/Original Research/Temporal-Trends-in-Sexual-Identity-and-Sociodemographic-Disparities-in-Stockholm-County-2010-to-2021/prop_imp_age_iteration_2014.xlsx") %>%
  filter( subgroup == 'young' ) %>%
  select( -subgroup )

prop_imp_age_iteration_2021 <- read_excel("/Users/guoqiang.zhang/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Karolinska Institutet/Research Projects/Population Trends and Individual Fluidity of Sexual Identity in Stockholm County/Original Research/Temporal-Trends-in-Sexual-Identity-and-Sociodemographic-Disparities-in-Stockholm-County-2010-to-2021/prop_imp_age_iteration_2021.xlsx") %>%
  filter( subgroup == 'young' ) %>%
  select( -subgroup )
...
```{r}
prop_imp_age_group_2010 <- read_xlsx("/Users/guoqiang.zhang/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Karolinska Institutet/Research Projects/Population Trends and Individual Fluidity of Sexual Identity in Stockholm County/Original Research/Temporal-Trends-in-Sexual-Identity-and-Sociodemographic-Disparities-in-Stockholm-County-2010-to-2021/prop_imp_age_group_sex_2010.xlsx") %>%
...
prop_imp_age_group_2014 <- read_xlsx("/Users/guoqiang.zhang/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Karolinska Institutet/Research Projects/Population Trends and Individual Fluidity of Sexual Identity in Stockholm County/Original Research/Temporal-Trends-in-Sexual-Identity-and-Sociodemographic-Disparities-in-Stockholm-County-2010-to-2021/prop_imp_age_group_sex_2014.xlsx") %>%
...
prop_imp_age_group_2021 <- read_xlsx("/Users/guoqiang.zhang/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Karolinska Institutet/Research Projects/Population Trends and Individual Fluidity of Sexual Identity in Stockholm County/Original Research/Temporal-Trends-in-Sexual-Identity-and-Sociodemographic-Disparities-in-Stockholm-County-2010-to-2021/prop_imp_age_group_sex_2021.xlsx") %>%
...
prop_imp_age_group_2010$subgroup[ prop_imp_age_group_2010$subgroup == "[17,19].Male" ] <- "(17,19].Male"
prop_imp_age_group_2010$subgroup[ prop_imp_age_group_2010$subgroup == "[17,19].Female" ] <- "(17,19].Female"

prop_imp_age_group_2014$subgroup[ prop_imp_age_group_2014$subgroup == "[15,17].Male" ] <- "[16,17].Male"
prop_imp_age_group_2014$subgroup[ prop_imp_age_group_2014$subgroup == "[15,17].Female" ] <- "[16,17].Female"

prop_imp_age_group_2021$subgroup[ prop_imp_age_group_2021$subgroup == "[15,17].Male" ] <- "[16,17].Male"
prop_imp_age_group_2021$subgroup[ prop_imp_age_group_2021$subgroup == "[15,17].Female" ] <- "[16,17].Female"
...
prop_imp_age_group_merged <- prop_imp_age_group_merged %>%
  filter( !new_subgroup %in% c( "[80,105]", "[80,99]", "[80,100]" ) )
...
##### 2.9.2. Plotting
```{r}
# plotting for bisexual identity
ggplot( long_data_age_group %>%
          filter( Sexuality %in% c( "Bisexual" ) ), 
        aes( x = new_subgroup, y = Value, color = sex, linetype = Year,  group = interaction( sex, Year ) ) ) +
  
  geom_line( linewidth = 0.5 ) +
  
  scale_y_continuous( labels = scales::percent, limits = c( 0, 0.2 ), breaks = c( 0, 0.05, 0.1, 0.15, 0.2 ) ) +
...
# plotting for homosexual identity
ggplot( long_data_age_group %>%
          filter( Sexuality %in% c( "Homosexual" ) ), 
        aes( x = new_subgroup, y = Value, color = sex, linetype = Year,  group = interaction( sex, Year ) ) ) +
  
  geom_line( linewidth = 0.5 ) +
  
  scale_y_continuous( labels = scales::percent, limits = c( 0, 0.08 ), breaks = c( 0, 0.02, 0.04, 0.06, 0.08 ) ) +
  ...
  labs( x = "Age Group (Years)ᵃ", 
        y = "Proportion of Homosexual Identity"
  ) +
...
# plotting for heterosexual identity
ggplot( long_data_age_group %>%
          filter( Sexuality %in% c( "Heterosexual" ) ), 
        aes( x = new_subgroup, y = Value, color = sex, linetype = Year,  group = interaction( sex, Year ) ) ) +
  
  geom_line( linewidth = 0.5 ) +
  
  scale_y_continuous( labels = scales::percent, limits = c( 0.6, 1 ), breaks = c( 0.6, 0.7, 0.8, 0.9, 1 ) ) +
  ...
  labs( x = "Age Group (Years)ᵃ", 
        y = "Proportion of Heterosexual Identity"
  ) +
...
# plotting for other identities
ggplot( long_data_age_group %>%
          filter( Sexuality %in% c( "Other" ) ), 
        aes( x = new_subgroup, y = Value, color = sex, linetype = Year,  group = interaction( sex, Year ) ) ) +
  ...
  labs( x = "Age Group (Years)ᵃ", 
        y = "Proportion of Other Identitiesᵇ"
  ) +
...
#### 2.10. LGB identity by sex
##### 2.10.1. Prepare dataset for plotting
```{r}
# datasets for proportion of sexual identity
prop_imp_summary_2010 <- read_excel("/Users/guoqiang.zhang/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Karolinska Institutet/Research Projects/Population Trends and Individual Fluidity of Sexual Identity in Stockholm County/Original Research/Temporal-Trends-in-Sexual-Identity-and-Sociodemographic-Disparities-in-Stockholm-County-2010-to-2021/prop_imp_summary_2010.xlsx")
prop_imp_summary_2014 <- read_excel("/Users/guoqiang.zhang/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Karolinska Institutet/Research Projects/Population Trends and Individual Fluidity of Sexual Identity in Stockholm County/Original Research/Temporal-Trends-in-Sexual-Identity-and-Sociodemographic-Disparities-in-Stockholm-County-2010-to-2021/prop_imp_summary_2014.xlsx")
...
prop_imp_summary_2010 <- prop_imp_summary_2010 %>% slice( c( 1:4, 15:24, 42 ) )
prop_imp_summary_2014 <- prop_imp_summary_2014 %>% slice( c( 1:4, 17:26, 44 ) )
prop_imp_summary_2021 <- prop_imp_summary_2021 %>% slice( c( 1:4, 17:26, 40 ) )
...
prop_imp_summary_filtered <- prop_imp_summary %>%
  select( 1, contains( "Homosexual" ), contains( "Bisexual" ) )

prop_imp_lgb_2010 <- read_excel('/Users/guoqiang.zhang/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Karolinska Institutet/Research Projects/Population Trends and Individual Fluidity of Sexual Identity in Stockholm County/Original Research/Temporal-Trends-in-Sexual-Identity-and-Sociodemographic-Disparities-in-Stockholm-County-2010-to-2021/prop_imp_lgb_2010.xlsx')
prop_imp_lgb_2010$subgroup[ prop_imp_lgb_2010$subgroup == "18-29" ] <- "16-29"
prop_imp_lgb_2010$subgroup[ prop_imp_lgb_2010$subgroup == "18-29.Male" ] <- "16-29.Male"
prop_imp_lgb_2010$subgroup[ prop_imp_lgb_2010$subgroup == "18-29.Female" ] <- "16-29.Female"

prop_imp_lgb_2014 <- read_excel('/Users/guoqiang.zhang/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Karolinska Institutet/Research Projects/Population Trends and Individual Fluidity of Sexual Identity in Stockholm County/Original Research/Temporal-Trends-in-Sexual-Identity-and-Sociodemographic-Disparities-in-Stockholm-County-2010-to-2021/prop_imp_lgb_2014.xlsx')

prop_imp_lgb_2021 <- read_excel('/Users/guoqiang.zhang/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Karolinska Institutet/Research Projects/Population Trends and Individual Fluidity of Sexual Identity in Stockholm County/Original Research/Temporal-Trends-in-Sexual-Identity-and-Sociodemographic-Disparities-in-Stockholm-County-2010-to-2021/prop_imp_lgb_2021.xlsx')

prop_imp_lgb_summary <- prop_imp_summary_filtered %>%
  full_join( prop_imp_lgb_2010, by = "subgroup" ) %>%
  full_join( prop_imp_lgb_2014, by = "subgroup" ) %>%
  full_join( prop_imp_lgb_2021, by = "subgroup" )

str( prop_imp_lgb_summary )

# convert the data into long format
prop_imp_lgb_summary_long <- prop_imp_lgb_summary %>%
  pivot_longer(
    cols = -subgroup,
    names_to = c( "sexual_identity", "measure", "year" ),
    names_pattern = "(Homosexual|Bisexual|LGB)_(.*)_(\\d{4})",
    values_to = "value"
    ) %>%
  pivot_wider(
    names_from = measure,
...
```{r}
# by sex
ggplot( prop_imp_lgb_summary_long %>% 
  ...
  scale_color_manual( values = c( "#C77CFF", "#00BFC4", "#F8766D"  ),
                      breaks = c( "Bisexual", "Homosexual", "LGB" ),
                      guide = guide_legend( nrow = 1 ) ) +
...
# by age
ggplot( prop_imp_lgb_summary_long %>% 
          filter( subgroup %in% c( "16-29", "30-44", "45-59", ">=60" ) ) %>%
  ...
  facet_grid( ~ subgroup,
              switch = "y",
              labeller = labeller( subgroup = c( "16-29" = "16–29 yrsᵃ",
                                                 "30-44" = "30–44 yrs",
                                                 "45-59" = "45–59 yrs",
                                                 ">=60" = "\u2265 60 yrs" ) ) ) 
```
...
```{r}
# by age and sex
prop_imp_lgb_summary_long_filtered <- 
  prop_imp_lgb_summary_long %>% slice( c( 55:126 ) ) %>%
  separate( subgroup, into = c( "subgroup", "sex" ), sep = "\\." )

ggplot( prop_imp_lgb_summary_long_filtered %>% 
          mutate( subgroup = factor( subgroup,
                                     levels = c( "16-29", "30-44", "45-59", ">=60" ) ) ),
        aes( x = year, y = point_estimate, color = sexual_identity, group = sexual_identity ) ) +
  ...
  ggh4x::facetted_pos_scales( y = list(
    sex == "Female" ~ scale_y_continuous( labels = scales::percent, limits = c( 0, 0.2 ), breaks = c( 0, 0.05, 0.10, 0.15, 0.20 ) ),
    sex == "Male" ~ scale_y_continuous( labels = scales::percent, limits = c( 0, 0.09 ), breaks = c( 0, 0.03, 0.06, 0.09 ) )
  ) )
```
...
```{r}
results_imp_pr_poisson_2010 <- read_xlsx("/Users/guoqiang.zhang/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Karolinska Institutet/Research Projects/Population Trends and Individual Fluidity of Sexual Identity in Stockholm County/Original Research/Temporal-Trends-in-Sexual-Identity-and-Sociodemographic-Disparities-in-Stockholm-County-2010-to-2021/results_imp_pr_poisson_2010.xlsx")

results_imp_pr_poisson_2014 <- read_xlsx("/Users/guoqiang.zhang/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Karolinska Institutet/Research Projects/Population Trends and Individual Fluidity of Sexual Identity in Stockholm County/Original Research/Temporal-Trends-in-Sexual-Identity-and-Sociodemographic-Disparities-in-Stockholm-County-2010-to-2021/results_imp_pr_poisson_2014.xlsx")

results_imp_pr_poisson_2021 <- read_xlsx("/Users/guoqiang.zhang/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Karolinska Institutet/Research Projects/Population Trends and Individual Fluidity of Sexual Identity in Stockholm County/Original Research/Temporal-Trends-in-Sexual-Identity-and-Sociodemographic-Disparities-in-Stockholm-County-2010-to-2021/results_imp_pr_poisson_2021.xlsx")
